<?php ob_start();
    ...
    $content.= '<tr>
                    ...
                    <th style="background-color: #e63946; color: white; padding: 10px;">Name</th>
                    <th style="background-color: #e63946; color: white; padding: 10px;">Email</th>
                    <th style="background-color: #e63946; color: white; padding: 10px;">Alamat</th>
                    <th style="background-color: #e63946; color: white; padding: 10px;">Role</th>
                    <th style="background-color: #e63946; color: white; padding: 10px;">No. Telp</th>
                    <th style="background-color: #e63946; color: white; padding: 10px;">Gender</th>
                </tr>';
