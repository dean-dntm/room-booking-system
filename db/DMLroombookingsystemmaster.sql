...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 05, 2020 at 05:57 AM
...
(2, 'Computer Science', 'Ahlijati Nuraminah, S.Kom, MTI'),
(3, 'Information System', 'Asri Pertiwi, S.T., MM'),
(4, 'Business Management', 'Leli Deswindi S.E., MT');
...
(33, 'Auditorium Prof. Ir. Surna Tjajha Djadjadiningrat', 200, 18, 'Auditorium.jpg', 27);
...
(11, 'Ammar', 'abdullah.a@students.esqbs.ac.id', '$2y$10$mHn5hdbSuffRJgs7/7k7/u/izMxVG5//vodhdJWbGKHeloPqSVTMe', 'Tegal, Jawa Tengah, Indonesia, Benua Asia, Bumi, Tata Surya', 'Mahasiswa', '08143256789', 'M'),
...
--
ALTER TABLE `ruangan`
  MODIFY `IDRuangan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
