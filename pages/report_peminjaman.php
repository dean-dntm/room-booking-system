<?php ob_start();
    ...
    $content.= '<tr>
                    <th style="background-color: #e63946; color: white; padding: 10px;">No.</th>
                    <th style="background-color: #e63946; color: white; padding: 10px;">Ruangan</th>
                    <th style="background-color: #e63946; color: white; padding: 10px;">Tgl Pinjam</th>
                    <th style="background-color: #e63946; color: white; padding: 10px;">Tgl Selesai</th>
                    <th style="background-color: #e63946; color: white; padding: 10px;">Jam Pinjam—Selesai</th>
                    <th style="background-color: #e63946; color: white; padding: 10px;">Persetujuan</th>
                    <th style="background-color: #e63946; color: white; padding: 10px;">Tgl Persetujuan</th>
                </tr>';
