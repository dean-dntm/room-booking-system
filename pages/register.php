    ...
    if(isset($_POST['btnSubmit'])){
        ...
        if ($objRegister->hasil) {
            ...
            if($objPeminjam->hasil){			
                ...
                $body = '<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #e63946;">
                        ...
                        <span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #e63946;">
        ...
        <div class="row justify-content-center align-items-center " style="height:100%">
            <div class="col-6 ">
                <div class="card shadow p-3 mb-5 mt-5 bg-white rounded border-0">
                    <div class="card-body">
                        <h2>Register</h2>
                        <p>Daftar untuk meminjam ruangan gedung Pemkab Demak</p> 
