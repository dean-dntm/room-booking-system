        ...
        <div class="col-md-9">
		    <div class="card shadow p-3 mb-5 mt-5 bg-white rounded border-0">
		        <div class="card-body">
		            <div class="row">
		                <div class="col-md-12">
		                    <h4><i class="fas fa-user"></i> Profil Anda</h4>
		                    <hr>
		                </div>
		            </div>
		            <div class="row">
		                <div class="col-md-12">
                            <form action="" autocomplete="off" method="POST">
                                ...
                                <div class="form-group" role="tab-list">
                                    <label for="pekerjaan">Jabatan</label></br>
                                    <?php
                                            $pekerjaan = array("Umum", "Instansi");
                                ...
                                <div class="tab-content">
                                    <?php
                                        if($objRegister->role == "Instansi"){
                                            echo '<div class="form-group tab-pane active" id="Instansi-content">';
                                ...
                                <!-- Prodi -->
                                <div class="form-group">
                                    <label for="instansi">Prodi</label>
                                    <select name="instansi" class="form-control" id="instansi">
                                        <?php
                                            foreach($instansiList as $instansi){
                                                if ($objPeminjam->IDinstansi == $instansi->IDInstansi ) {
                                                    echo '<option selected value="'.$instansi->IDInstansi.'">'.$intansi->namaInstansi.'</option>';
                                                } else {
                                                    echo '<option value="'.$instansi->IDInstansi.'">'.$instansi->namaInstansi.'</option>';
                                                }
