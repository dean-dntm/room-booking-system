...
<head>
    ...
    <title>Sistem Sewa Gedung</title>
    ...
    <body>
        <nav class="navbar navbar-expand-sm navbar-light bg-white text-dark shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="index.php"><strong>Sistem Sewa Gedung</strong></a>
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="dashboardInstansi.php?p=listRuangan">Ruangan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="dashboardInstansi.php?p=listInstansi">Instansi</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="dashboardInstansi.php?p=listFasilitas">Fasilitas</a>
                    </li>
                </ul>
            ...
            <?php
                ...
                if(!empty($_GET['p'])){
                    ...
                    if(in_array($p.'.php', $pages)){
                        ...
                        echo '</br>';
                        echo '<a href="dashboardInstansi.php?p=listRuangan.php">&larr; Go Home</a>';
                        echo '</div>';
                    }
                } else {
        ...
        <footer class="container-fluid bg-white border-top">
            <div class="container footer">
                <small>&copy; Copyright 2021, Pemkab Demak</small>
            </div>
        </footer>
    </body>
    <!-- <script>
